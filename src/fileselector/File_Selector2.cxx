//
// "$Id: File_Selector2.cxx 4660 2005-11-27 14:45:48Z mike $"
//
// More File_Selector routines.
//
...
// Contents:
//
//   File_Selector::count()             - Return the number of selected files.
//   File_Selector::directory()         - Set the directory in the file chooser.
//   File_Selector::filter()            - Set the filter(s) for the chooser.
//   File_Selector::newdir()            - Make a new directory.
//   File_Selector::value()             - Return a selected filename.
//   File_Selector::rescan()            - Rescan the current directory.
//   File_Selector::fileListCB()        - Handle clicks (and double-clicks)
//                                          in the Fl_File_Browser.
//   File_Selector::fileNameCB()        - Handle text entry in the FileBrowser.
//   File_Selector::showChoiceCB()      - Handle show selections.
...
const char	*File_Selector::all_files_label = "All Files (*)";
const char	*File_Selector::custom_filter_label = "Custom Filter";
const char	*File_Selector::existing_file_label = "Please choose an existing file!";
const char	*File_Selector::filename_label = "Filename:";
#ifdef WIN32
const char	*File_Selector::filesystems_label = "My Computer";
#else
const char	*File_Selector::filesystems_label = "File Systems";
#endif // WIN32
const char	*File_Selector::new_directory_label = "New Directory?";
const char	*File_Selector::new_directory_tooltip = "Create a new directory.";
const char	*File_Selector::preview_label = "Preview";
const char	*File_Selector::save_label = "Save";
const char	*File_Selector::show_label = "Show:";
Fl_File_Sort_F	*File_Selector::sort = fl_numericsort;
...
void
File_Selector::directory(const char *d)// I - Directory to change to
{
  char	*dirptr;			// Pointer into directory


//  printf("File_Selector::directory(\"%s\")\n", d == NULL ? "(null)" : d);
...
//
// 'File_Selector::fileListCB()' - Handle clicks (and double-clicks) in the
//                                   Fl_File_Browser.
//

void
File_Selector::fileListCB()
{
...
void
File_Selector::filter(const char *p)		// I - Pattern(s)
{
...
//
// 'File_Selector::preview()' - Enable or disable the preview tile.
//

void
File_Selector::preview(int e)// I - 1 = enable preview, 0 = disable preview
{
...
//
// 'File_Selector::previewCB()' - Timeout handler for the preview box.
//

void
File_Selector::previewCB(File_Selector *fc) {	// I - File chooser
  fc->update_preview();
}
...
//
// 'File_Selector::update_preview()' - Update the preview box...
//

void
File_Selector::update_preview()
{
...
File_Selector::value(int f)	// I - File number
{
  int		i;		// Looping var
  int		fcount;		// Number of selected files
...
//
// 'File_Selector::value()' - Set the current filename.
//

void
File_Selector::value(const char *filename)
...
//
// End of "$Id: File_Selector2.cxx 4660 2005-11-27 14:45:48Z mike $".
//
