// ----------------------------------------------------------------------------
//
//	DomEX_vari.cxx  --  DominoEX FEC Varicode
//
// Copyright (C) 2006
//		Dave Freese, W1HKJ
//
...
// table structures are idential to mfskvaricode.cxx

static char *varicode[256] = {
	"11101011100",		// 000 <NUL>
	"11101100000",		// 001 <SOH>
	"11101101000",		// 002 <STX>
	"11101101100",		// 003 <ETX>
 ...
 */
static unsigned int varidecode[256] = {
...
{
	for (int c = 0; c < 256; c++) {
		if (c && (c % 8 == 0)) printf(" // %3d\n", c);
		printf("0x%03X, ", vari2hex(c));
	}
}
