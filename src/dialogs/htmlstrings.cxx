...
<h2 id=\"_beginners_questions_answered\">1. Beginners' Questions Answered</h2>\n\
<div class=\"sectionbody\">\n\
...
<h2 id=\"_setting_up\">2. Setting Up</h2>\n\
<div class=\"sectionbody\">\n\
...
<li>\n\
<p>\n\
If you have more than one soundcard, use the menu <tt>Configure&#8594;Sound Card</tt>,\n\
...
When you start Fldigi for the very first time, it makes a series of\n\
  ...
  (under 700MHz), you should verify that <em>Slow CPU</em> under <tt>Configure&#8594;Misc&#8594;CPU</tt>\n\
...
<h2 id=\"_guided_tour\">3. Guided Tour</h2>\n\
<div class=\"sectionbody\">\n\
...
<dt>\n\
<tt>FFT</tt> (Fast Fourier Transform)\n\
</dt>\n\
<dd>\n\
<p>\n\
...
modes.</p></div>\n\
<div class=\"para\"><p>The Frequency, Time Off, and (when in contest mode) #Out fields are filled by\n\
the program.  All the others can be populated by manual keyboard entry or by\n\
selection from the <a href=\"#ref-receive-pane\">Receive pane</a>. The Time Off field is\n\
continuously updated with the current GMT time.  The Time On field will be\n\
filled in when the Call is updated, but can be modified later by the operator.</p></div>\n\
...
<div class=\"para\"><p>Certain fields (Call, Name, RST In, QTH and Locator) may also be populated\n\
...
<em>Look up call</em> from the popup menu.  The latter will also move the call to the\n\
Call field.</p></div>\n\
<div class=\"para\"><p>When the Call field is filled in, the logbook will be searched for the most\n\
...
also be selected for viewing in the logbook.</p></div>\n\
...
change. These menu functions are:</p></div>\n\
...
mode you used.</p></div>\n\
<div class=\"para\"><p>Not all the modes are widely used, so choose a mode which <em>(a)</em> maximizes your\n\
...
<div class=\"para\"><p>The two non-menu functions are:</p></div>\n\
...
<h3 id=\"_functions\">3.6. Functions</h3><div style=\"clear:left\"></div>\n\
...
that the buttons also turn the transmitter on and off as necessary.</p></div>\n\
...
<div class=\"para\"><p>The <tt>Lk</tt> button locks the transmit frequency (fixes the red cursors), and the Rv\n\
...
you hear is upside down, check your transceiver sideband setting.</p></div>\n\
...
<td class=\"content\">\n\
<div class=\"para\"><p>Use this with care, as it will stop transmission immediately, losing whatever is\n\
in the buffer (what you have typed in the Transmit pane), or start it\n\
immediately, even if nothing is ready to transmit.</p></div>\n\
</td>\n\
</tr></table>\n\
</div>\n\
...
<p>\n\
  ...
  <em>text</em> received, even if there is no signal present, and the receiver is\n\
...
<h2 id=\"_operating\">4. Operating</h2>\n\
<div class=\"sectionbody\">\n\
...
<li>\n\
<p>\n\
<strong><tt>&gt;&gt;</tt></strong> The transmitter comes on and stays on when you use this button/macro.\n\
</p>\n\
</li>\n\
<li>\n\
<p>\n\
<strong><tt>||</tt></strong> The transmitter goes off when the text from this button/macro has been\n\
  sent.\n\
</p>\n\
</li>\n\
<li>\n\
<p>\n\
<strong><tt>&gt;|</tt></strong> The transmitter comes on, sends the text from this button/macro, and\n\
...
<h2 id=\"_special_keys\">5. Special Keys</h2>\n\
<div class=\"sectionbody\">\n\
...
that entry value into the transmit buffer. For example, <tt>Ctrl 177</tt> is <tt>±</tt>\n\
(plus/minus) and <tt>Ctrl 176</tt> is <tt>°</tt> (degree). If you press a key other than the\n\
numeric keypad's 0-9 the sequence will be discarded.</p></div>\n\
</div>\n\
<h2 id=\"_credits\">6. Credits</h2>\n\
<div class=\"sectionbody\">\n\
