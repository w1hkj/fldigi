...
static void cb_btnXMIT(Fl_Button*, void*) {
  choose_color((Fl_Color*)&progdefaults.XMITcolor);
...
static void cb_btnCTRL(Fl_Button*, void*) {
  choose_color((Fl_Color*)&progdefaults.CTRLcolor);
...
static void cb_btnSKIP(Fl_Button*, void*) {
  choose_color((Fl_Color*)&progdefaults.SKIPcolor);
...
static void cb_btnALTR(Fl_Button*, void*) {
  choose_color((Fl_Color*)&progdefaults.ALTRcolor);
...
Fl_Double_Window* make_colorsfonts() {
  { dlgColorFont = new Fl_Double_Window(370, 274, "Colors and Fonts");
    ...
    { Fl_Group* o = new Fl_Group(185, 5, 185, 240, "Text Controls");
      ...
      { RxText = new Fl_Input(195, 30, 165, 35);
        ...
        RxText->textfont(progdefaults.RxFontnbr); RxText->textsize(progdefaults.RxFontsize); RxText->textcolor((Fl_Color)progdefaults.RxFontcolor);
      ...
      { TxText = new Fl_Input(195, 100, 165, 35);
        ...
        TxText->textfont(progdefaults.TxFontnbr); TxText->textsize(progdefaults.TxFontsize); TxText->textcolor((Fl_Color)progdefaults.TxFontcolor);
    ...
    { Fl_Group* o = new Fl_Group(0, 160, 185, 85, "Widgets");
      o->box(FL_ENGRAVED_FRAME);
      o->align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE);
