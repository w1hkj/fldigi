...
//	waveshape = progdefaults.waveshape;
	waveshape = false;
	makeshape();
	sync_parameters();
...
//	if (waveshape != progdefaults.waveshape) {
//		waveshape = progdefaults.waveshape;
//		makeshape();
//	}
...
{
	qskphase += 2.0 * M_PI * 800.0/samplerate;//1600.0 / samplerate;
