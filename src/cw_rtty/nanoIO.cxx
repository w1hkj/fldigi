...
//static bool nano_was = nanoIO_isCW;
//static bool farnsworth = progdefaults.CWusefarnsworth;
...
void nanoIO_correction()
{
	...
	std::string rsp  = nano_read_string(100, szcorr);
}
