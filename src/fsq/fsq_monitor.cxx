...
Fl_Double_Window* create_fsqMonitor(void)
{
	...
	fsq_monitor = new FTextRX(
		...
		fsq_monitor->setFont(FL_COURIER);//SCREEN);
		fsq_monitor->setFontSize(progdefaults.RxFontsize);
		fsq_monitor->setFontColor(progdefaults.RxFontcolor, FTextBase::RECV);
//		fsq_monitor->setFontColor(progdefaults.XMITcolor, FTextBase::XMIT);
//		fsq_monitor->setFontColor(progdefaults.CTRLcolor, FTextBase::CTRL);
//		fsq_monitor->setFontColor(progdefaults.SKIPcolor, FTextBase::SKIP);
//		fsq_monitor->setFontColor(progdefaults.ALTRcolor, FTextBase::ALTR);
