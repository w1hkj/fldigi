...
void create_logbook_dialogs() {
  ...
  { dlgLogbook = new Fl_Double_Window(570, 320, _("Logbook"));
    ...
    { editGroup = new Fl_Group(2, 2, 565, 200);
      ...
      { Fl_DateInput* o = inpQSLsentdate_log = new Fl_DateInput(462, 56, 100, 22, _("QSL-sent"));
