...
#define IFKP_FFTSIZE		2048
#define IFKP_SYMLEN			2048

#define IFKP_BLOCK_SIZE		IFKP_FFTSIZE
#define IFKP_SHIFT_SIZE		(IFKP_SYMLEN / 16)

#define IFKP_SHAPE_SIZE		64 // 5 msec rise time
...
//#define IFKP_SPACING		5
//#define IFKP_NUMBINS		247 // 5 bin spacing

enum IFKP_STATE {TEXT, IMAGE};
