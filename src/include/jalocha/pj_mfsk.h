...
// resize internal arrays according the parameters
    ...
    void PrintParameters(void) {
        ...
        printf(
        "%d bits/symbol(tone), %d tones, %4.2f Hz/tone, %4.1f Hz bandwidth\n",
        ...
        printf(
        "%4.2f baud, FEC block: %d char. => %dx%d bits, %3.1f sec\n",
        ...
        "Audio band: %3.1f - %3.1f Hz, %3.1f Hz total\n",
            ...
            FreqBin * (Demodulator.FirstCarrier + Demodulator.CarrierSepar * 
                      Demodulator.Carriers),
            FreqBin * Demodulator.CarrierSepar * Demodulator.Carriers );
